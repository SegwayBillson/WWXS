...
public class EncryptionUnit {
    ...
    private SecretKeyFactory symmetricKeyFactory;
    ...
    public EncryptionUnit(){
        ...
        try {
            //TODO: The symmetric key factory's AES/CBC/NoPadding algorithm is not able to be found
            //      however the RSA cypher still works below
            keyGen = KeyPairGenerator.getInstance(encryptionAlgorithm);
            symmetricKeyFactory = SecretKeyFactory.getInstance("AES/CBC/NoPadding");

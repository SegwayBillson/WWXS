...
public class DeviceScanActivity extends ListActivity {
    ...
    public class userDeviceTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            String urlString = "http://10.0.2.2:8080/buoy/";

            // TODO: LON and LAT are hard coded!!!!!!!!
            // Also, Lon and lat are only used during registering a buoy and not during collection?
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if (stationAddrs.contains(device.getAddress())) {
            ...
            Log.e(TAG, "Device MAC Address: " + device.getAddress());
            Log.e(TAG, "User Key: " + CurrentUser.key);
